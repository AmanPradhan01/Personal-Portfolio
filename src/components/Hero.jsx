  ...
  return <div className="border-b border-neutral-900 pb-4 lg:mb-35">
    <div className="flex flex-wrap">
        ...
        <div className="flex flex-col items-center lg:items-start">
            <motion.h1 variants={container(0)} initial="hidden" animate="visible" className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl">Aman Pradhan</motion.h1>
            ...
            <motion.a href="https://drive.google.com/file/d/1ogEK35yKPSQ6NEHzo0AFiY89scc-99QO/view?usp=sharing" variants={container(1)} initial="hidden" animate="visible"><button className="mr-2 border rounded bg-neutral-950 px-2 py-1 text-sm font-medium text-purple-900"><div className="m-100 flex items-center justify-center gap-0.5 text-2xl"><RiNewspaperLine />Resume </div></button></motion.a>
        </div>
        </div>
